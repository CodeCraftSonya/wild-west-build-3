...
const loaderUrl = buildUrl + "/Build 3.loader.js";
const config = {
    dataUrl: buildUrl + "/Build 3.data.unityweb",
    frameworkUrl: buildUrl + "/Build 3.framework.js.unityweb",
    codeUrl: buildUrl + "/Build 3.wasm.unityweb",
    streamingAssetsUrl: "StreamingAssets",
    companyName: "Day Zero Studio",
    productName: "Poker on the Wild West",
...
loadingCover.style.background = "linear-gradient(to top, #000000, #474747)";
